...
;; GnuCash report template called from taxinvoice.scm
;; (c) 2009 Chris Dennis chris@starsoftanalysis.co.uk
;;
;; $Author: chris $ $Date: 2009/05/27 00:40:12 $ $Revision: 1.31 $
;;
...
<style type="text/css">
  /* Note: the <style> element should be within the <head> section */
  /* not here in the <body> section.  But it seems to work...      */
  div.main { 
...
<tr valign="top">
  <td align="left">
    ...
    <?scm )) ?>
    <h1 class="coyname"><?scm:d (or coyname (_ "Company Name")) ?></h1></td>
  <td align="right"><h2><?scm:d opt-report-title ?></h2></td>
</tr>
<tr valign="top">
  <td align="left">
...
<!-- The HTML for the invoice ends here -->
<!-- ====================================================================== -->
